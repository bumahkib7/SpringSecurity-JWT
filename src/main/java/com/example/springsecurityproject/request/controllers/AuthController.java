...
import com.example.springsecurityproject.request.SignupRequest;
import com.example.springsecurityproject.response.JwtResponse;
import com.example.springsecurityproject.response.MessageResponse;
import com.example.springsecurityproject.security.jwt.JwtUtils;
import com.example.springsecurityproject.services.UserDetailsImpl;
...
public class AuthController  {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		Set<Object> strRoles = Collections.singleton(signUpRequest.getRole());
